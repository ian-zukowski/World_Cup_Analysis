...
1a. To answer the first question, it appears goals have trended downwards each year, with a peak in 1950 as can be seen ![[here](Analysis/Year-to-Year/Average_Scores_by_Year.png)](here).
